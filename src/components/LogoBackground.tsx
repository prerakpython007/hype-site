...
// Mobile logos — inside bordered frame
const mobileLogos = [
  { top: "3%", left: "5%", size: 62, rotate: -15, depth: 1.0 },
  { top: "5%", left: "65%", size: 58, rotate: 25, depth: 0.8 },
  { top: "12%", left: "35%", size: 60, rotate: -30, depth: 1.2 },
  { top: "18%", left: "75%", size: 56, rotate: 18, depth: 0.7 },
  { top: "22%", left: "8%", size: 64, rotate: 40, depth: 1.1 },
  { top: "30%", left: "55%", size: 58, rotate: -20, depth: 0.9 },
  { top: "38%", left: "20%", size: 62, rotate: 28, depth: 1.3 },
  { top: "45%", left: "70%", size: 56, rotate: -35, depth: 0.6 },
  { top: "52%", left: "10%", size: 60, rotate: 22, depth: 1.0 },
  { top: "58%", left: "50%", size: 58, rotate: -18, depth: 0.8 },
  { top: "65%", left: "80%", size: 62, rotate: 35, depth: 1.2 },
  { top: "72%", left: "30%", size: 56, rotate: -25, depth: 0.7 },
  { top: "80%", left: "60%", size: 60, rotate: 15, depth: 1.1 },
  { top: "88%", left: "15%", size: 58, rotate: -40, depth: 0.9 },
];
